...
class GameView(ui.RootElement):
    def __init__(self):
        ...
        pygame.mixer.music.load(globals.pyinst.path(os.path.join("resource", "sounds", "wind.ogg")))
        ...
        self.border = ui.Border(
            self, Point(0, 0), Point(1, 1), colour=drawing.constants.colours.black, line_width=2
        )
        ...
        self.platform3 = ui.ImageBox(
            globals.screen_root, Point(0.25, 0.65), Point(0.35, 0.675), "platform.png"
        )
        self.platform4 = ui.ImageBox(
            globals.screen_root, Point(0.65, 0.65), Point(0.75, 0.675), "platform.png"
        )
